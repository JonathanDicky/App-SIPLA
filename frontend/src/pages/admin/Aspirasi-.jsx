                      ...
                      <td className="px-4 py-3">
                        <div className="flex gap-1">
                          ...
                          <button onClick={() => handleDelete(p.id_pengaduan)}
                            className="text-red-500 hover:bg-red-50 px-2 py-1 rounded-lg text-xs font-medium border border-red-200 whitespace-nowrap">Hapus</button>
                        </div>
                      </td>
                    </tr>
                  )
                  ...
                  {selected.tanggapan.map(t => (
                    <div key={t.id_tanggapan} className="bg-emerald-50 border border-emerald-100 rounded-xl p-3 text-sm mb-2">
                      ...
                      {[t.file_bukti, t.file_bukti_2, t.file_bukti_3].filter(Boolean).map((f, i) => (
                        <a key={i} href={`http://localhost:8080/${f}`} target="_blank" rel="noreferrer"
